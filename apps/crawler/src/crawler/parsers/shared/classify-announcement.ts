...
import { normalizeTitleForClassification } from "./normalize-title.js";
...
const COUNSELLING_KEYWORDS = ["counselling", "counseling", "josaa"] as const;
...
/**
 * Classifies an announcement title into an EventType using
 * case-insensitive, punctuation-normalized keyword rules.
 */
export function classifyAnnouncementTitle(title: string): EventType {
